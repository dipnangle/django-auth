    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("override_features_json", models.JSONField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("previous_plan", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="+", to="plans.plan")),
                ("new_plan", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="+", to="plans.plan")),
            ],
